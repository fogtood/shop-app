const BUTTON_STYLES = {
  ...
  auth: "flex items-center justify-center xs:justify-start gap-2 bg-black text-white font-medium p-3 hover:bg-black/80 disabled:bg-black/50 disabled:cursor-not-allowed transition",
  btnWithIcon:
